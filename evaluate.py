...
parser.add_argument("--dataset_dir", default='/home/dww/OD/dataset/MDFA', type=str, help="train_dataset_dir")
...
def eval(): 
    ...
    for idx_iter, (pre_mask, gt_mask, size) in enumerate(test_loader):
        ...
        eval_roc.update(pre_mask[0,0,:,:],gt_mask[0,0,:,:])
    
    tp_rates, fp_rates, F1,recall,precision= eval_roc.get()
